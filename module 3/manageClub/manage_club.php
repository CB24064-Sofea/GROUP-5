...
if (!empty($filterClubID)) {
    $query = "SELECT c.clubID, c.clubName, c.advisor, s.studentID, s.studentName, s.studentEmail 
              FROM membership m 
...
<body>
    ...
    <header class="main-header">
        ...
        <div class="header-right">
            ...
            <button class="btn" style="background-color: #7f8c8d; color: white; padding: 6px 12px;">profile</button>
        </div>
    </header>
                            ...
                            if ($result && mysqli_num_rows($result) > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <div class="action-cell" style="justify-content: center;">
                                                ...
                                                <a href="delete_club.php?id=<?php echo urlencode($row['clubID']); ?>" class="btn btn-delete" onclick="return confirm('Are you sure you want to delete this option?');">Delete</a>
                                ...
                                <tr>
                                    <td colspan="<?php echo !empty($filterClubID) ? '7' : '5'; ?>" style="text-align: center; color: #7f8c8d; padding: 30px;">
                                        No active members registered under this selected club.
                                    </td>
                                </tr>
                                <?php
                            }
