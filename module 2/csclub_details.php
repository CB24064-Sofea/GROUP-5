...
if (!isset($_SESSION['userID']) || ($_SESSION['role'] !== 'Student' && $_SESSION['role'] !== 'Committee')) {
    echo "
    <script>
        alert('Unauthorized access! Please login as a Student or Committee member.');
...
$userQuery = "SELECT profilePhoto FROM user WHERE userID = '" . mysqli_real_escape_string($link, $loggedInUserID) . "' LIMIT 1";
...
$rolePath = ($_SESSION['role'] === 'Committee') ? 'committee' : 'student';
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <main class="main-content">
            <div class="wireframe-stack">
                ...
                <?php else: ?>
                    ...
                    <div class="action-container">
                        <a href="club_list.php" class="btn btn-secondary">Back to List</a>
                    </div>
