...
<head>
    ...
    <title>Clubs - FK Student Club & Event Management</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        /* Top Title Link inside the Panel Group */
        .submenu-container .nav-item {
            border: none;
            border-bottom: 1px solid #dcdde1;
            border-radius: 0;
            background-color: #eaeaea; /* Light grey base block color */
            font-weight: bold;
        }
        ...
        /* Current Page Sub-navigation Context Indicator */
        .active-sub {
    ...
    <div class="app-container">
        <aside class="sidebar">
            <nav class="sidebar-nav">
                <div class="submenu-container">
                    <a href="manage_club.php" class="nav-item">Clubs</a>
                    <div class="submenu">
                        <a href="manage_club.php" class="sub-nav-item active-sub">Registered Clubs</a>
                        <a href="join_club.php" class="sub-nav-item">Join Club</a>
                    </div>
                </div>
        ...
        <main class="main-content">
            <div class="workspace-stack">
                ...
                <h2 class="page-title">Registered Club Information</h2>
                ...
                <div class="filter-actions-bar">
                    <form action="manage_club.php" method="GET" class="filter-form">
                        <label for="filterClubID" style="font-weight: 600; color: #2c3e50; white-space: nowrap;">Filter by Club:</label>
                    ...
                    <a href="join_club.php" class="btn btn-add">Join Club</a>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <div class="action-cell" style="justify-content: center;">
                                                <a href="csclub_details.php?id=<?php echo urlencode($row['clubID']); ?>" class="btn btn-view">View</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php
