...
<body>
    ...
    <header class="main-header">
        ...
        <div class="header-right">
            ...
            <button class="btn btn-secondary" style="padding: 6px 12px;">profile</button>
        </div>
    </header>
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                ...
                <div class="submenu-container">
                    ...
                    <div class="submenu">
                        <a href="../manageClub/manage_club.php" class="sub-nav-item active-sub">Manage Club</a>
                        <a href="../addClub/create_club.php" class="sub-nav-item">Create Club</a>
                    </div>
                </div>
            ...
            <div class="wireframe-stack">
                ...
                <?php if (!empty($errorMessage)): ?>
                    ...
                    <div class="action-container">
                        <a href="../manageClub/manage_club.php" class="btn btn-secondary">Back</a>
                    </div>
                <?php else: ?>
